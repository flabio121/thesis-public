...
largest degradation. The current comparison supports that ordering
qualitatively, but it is not a calibrated lifetime prediction.

The agreement remains qualitative because the model uses accelerated
