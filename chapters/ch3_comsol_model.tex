...
differential equations on a shared geometry. The model and exported MATLAB
history used for this thesis were tested with COMSOL Multiphysics 6.4; earlier
COMSOL versions should be rechecked before reproducing the coupled PDE setup.
