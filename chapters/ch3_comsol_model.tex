...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{figures/eee598_comsol/psc_stack_1d_comsol_geometry.png}
\caption{Reduced 1-D COMSOL geometry used for PSC J--V and hysteresis model development. The stack keeps transport layers, perovskite absorber, and interface regions explicit so that losses can be assigned to physical domains rather than only to terminal curve shape.}
