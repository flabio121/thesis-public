...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/pptx_ai/degradation_implementation_graphic.png}
\caption[COMSOL degradation implementation concept.]{COMSOL degradation implementation concept. Stressors drive slow damage-state evolution; damage states map to trap density, surface recombination, series resistance, shunt resistance, and effective generation; the updated parameters are then used in fast J--V simulations to produce mechanism-specific performance loss.}
\label{fig:degradation_implementation_graphic}
\end{figure}
...
\end{equation}
This mapping is useful for testing absorber damage or optical loss. Its
primary J--V signature is reduced $J_{sc}$, with secondary effects on PCE and
possibly FF. It should not be used to represent recombination loss unless
