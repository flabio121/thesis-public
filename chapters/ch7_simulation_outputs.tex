...
$u_{\mathrm{ion}}$ is a normalization diagnostic rather than a strict
conservation integral.
The DIT governing equations and extraction methods are implemented or
documented, but the quantitative transient result remains pending until a
frozen-ion or no-ion control current is exported for background subtraction.
