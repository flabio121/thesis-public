...
The results are organized from controlled mechanism checks to broader
stress-grid and surrogate analyses. The purpose is to show how the COMSOL model
responds when electronic parameters, degradation states, light, temperature,
aging time, and spatial profiles are examined separately and together.
