...
by the model. The DIT governing equations and extraction methods are
implemented or documented, but the quantitative transient result is not claimed
as a final result until a matched frozen-ion or no-ion control current is
exported for background subtraction.
