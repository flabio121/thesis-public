...
qualitative mechanism separation, produces surrogate-ready COMSOL state
summaries, and provides a first grouped-validation surrogate baseline, but
experimental calibration remains ongoing. Future work should improve absolute
calibration, validate ion-sensitive parameters with frozen-ion controls,
extend the diagnostic voltage window, implement light-soaking and self-healing
terms, and develop architecture-specific parameter sets.
